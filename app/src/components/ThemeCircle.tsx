...
const ThemeCircle = ({ bg, accent, text, textlight, className }: IProps) => {
    return (
        <div className="w-[50px] h-[50px] pl-[10px] pt-[10px]">
            ...
            ></div>
            <div
                className={`w-[50px] h-[50px] rounded-full relative bottom-[50px] `}
                style={{
            ...
            ></div>
            <div
                className={`w-[50px] h-[50px] rounded-full relative bottom-[100px] `}
                style={{
            ...
            ></div>
            <div
                className={`w-[50px] h-[50px] rounded-full relative bottom-[150px] `}
                style={{
